...
export default function JobsDetail(props) {
  ...
  async function onLoad() {
    ...
    backendRestApi.genericGet("jobs/getById/"+id, loadItemsCallback);
  }
  ...
  <div className={classes.table}>
    <a href="/jobs-history" style={{ textDecoration: 'none' }}>
    ...
    <Paper elevation={3}>
      ...
      <Typography variant="button" display="block" gutterBottom>
        {detailsItems.pay_status}
      </Typography>
      <Typography variant="caption" display="block" gutterBottom>
      {detailsItems.artefact_id}
      </Typography>
      <Typography variant="caption" display="block" gutterBottom>
      {detailsItems.dictionaries_id}
      </Typography>
