...
export default function ArtifactsDetail(props) {
  ...
  async function onLoad() {
    ...
    backendRestApi.genericGet("artifacts/getById/"+id, loadItemsCallback);
  }
  ...
  <div className={classes.table}>
    ...
    <Paper elevation={3}>
      <Typography variant="h3" gutterBottom>
        {detailsItems.original_file_name}
      </Typography>
      <Typography variant="button" display="block" gutterBottom>
        {detailsItems.status}
      </Typography>
      <Typography variant="caption" display="block" gutterBottom>
      {detailsItems.upload_file_type}
      </Typography>
      ...
      {/* <div className={classes.multiline}>
        {detailsItems.output_text}
        {JSON.stringify(detailsItems)}
      </div> */}
    </Paper>
    }
